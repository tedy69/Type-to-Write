...
const textareaNameEl = document.querySelector(
  ".page > .paper-margin-top-line > .textarea"
);
...
function init() {
  ...
  dateTilt = randomNr();
  document.getElementById("date-container").style.transform =
    "rotate(" + dateTilt + "deg)";
  ...
  textareaEl.style.fontFamily =
    document.getElementById("handwriting-font").value;
  ...
  textareaEl.style.paddingTop =
    document.getElementById("top-padding").value + "px";
  textareaEl.style.wordSpacing =
    document.getElementById("word-spacing").value + "px";
  textareaNameEl.style.fontFamily =
    document.getElementById("handwriting-font").value;
  textareaNameEl.style.color = document.getElementById("ink-color").value;
  textareaNameEl.style.fontSize =
    document.getElementById("font-size").value + "pt";
  textareaNameEl.style.paddingTop =
    document.getElementById("top-padding").value + "px";
  textareaNameEl.style.wordSpacing =
    document.getElementById("word-spacing").value + "px";
}
...
function readFile(fileObj) {
  ...
  reader.onload = (e) => {
    ...
    newFont.load().then((loadedFace) => {
      ...
      textareaNameEl.style.fontFamily = "temp-font";
    });
  };
...
function applyPaperStyles() {
  ...
  if (liner.checked == false) {
    ...
    textareaNameEl.classList.remove("paper-lined");
    textareaNameEl.classList.add("paper");
  }
  if (liner.checked == true) {
    textareaEl.classList.remove("paper");
    textareaEl.classList.add("paper-lined");
    textareaNameEl.classList.remove("paper");
    textareaNameEl.classList.add("paper-lined");
  }
}
...
document
  .querySelector("select#handwriting-font")
  .addEventListener("change", (e) => {
    textareaEl.style.fontFamily = e.target.value;
    textareaNameEl.style.fontFamily = e.target.value;
    ...
    if (e.target.value == "'Homemade Apple', cursive") {
      ...
      textareaNameEl.style.paddingTop = 2;
    }
...
document
  .querySelector("#paper-margin-toggle")
  .addEventListener("change", (e) => {
...
document.querySelector("#paper-date-toggle").addEventListener("change", (e) => {
  if (document.getElementById("paper-date-toggle").checked == false) {
    document.querySelector(
      ".page > .paper-margin-top-line > .textarea > .paper-margin-left-line"
    ).style.display = "none";
    document.getElementById("name-note").style.paddingLeft = "30px";
    document.getElementById("date-day").disabled = true;
    document.getElementById("date-month").disabled = true;
    document.getElementById("date-year").disabled = true;
    document.getElementById("date-format").disabled = true;
...
function infotab() {
  ...
  if (
    document.getElementById("info-tab").classList.contains("info-hider") == true
  ) {
